...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210183321/7.png"
		...
		<div class="main"> 
			...
			<a href="/ide?cuenta=<?php echo s($empresa->token_m); ?>" target="_blank"><div class="box box1"> 
					<div class="text"> 
				...
				<a href="/Qre?cuenta=<?php echo s($empresa->token_m); ?>"><div class="box box4"> 
					<div class="text"> 
...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210185029/13.png" alt="published"> 
			...
			<div class="report-container"> 
				<div class="report-header"> 
					...
					<a href="/perfil_empresarial"><button class="view">Modificar</button></a>
				</div> 
				<br>
            ...
            <div class="campo">
            <label>Nombre de la empresa: <?php echo s($empresa->nombre); ?></label>
            </div>
			<div class="campo">
            <label>Nombre de contacto: <?php echo s($empresa->contacto); ?></label>
            </div>
            <div class="campo">
